...
class ConversationRepository:
    ...
    async def list_all(self, user_id: str, page: int = 1, page_size: int = 20) -> tuple[list[Conversation], int]:
    ...
    async def update(
        self, conversation_id: str, data: dict, user_id: str
    ) -> Conversation | None:
    ...
    async def add_message(
        self, conversation_id: str, data: MessageCreate, user_id: str, model: str | None = None
    ) -> Message:
        message = Message(
