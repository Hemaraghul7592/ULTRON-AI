...
async def test_user_isolation_conversations(client: AsyncClient):
    r1 = await client.post(
        ...
        json={"username": "user_a", "password": "TestPass123!"},
    )
    ...
    r2 = await client.post(
        "/api/v1/auth/register",
        json={"username": "user_b", "password": "TestPass123!"},
    )
...
async def test_user_isolation_memories(client: AsyncClient):
    r1 = await client.post(
        "/api/v1/auth/register",
        json={"username": "user_c", "password": "TestPass123!"},
    )
    ...
    r2 = await client.post(
        "/api/v1/auth/register",
        json={"username": "user_d", "password": "TestPass123!"},
    )
...
async def test_user_isolation_tasks(client: AsyncClient):
    r1 = await client.post(
        "/api/v1/auth/register",
        json={"username": "user_e", "password": "TestPass123!"},
    )
    ...
    r2 = await client.post(
        "/api/v1/auth/register",
        json={"username": "user_f", "password": "TestPass123!"},
    )
